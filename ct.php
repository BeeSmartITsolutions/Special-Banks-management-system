...
<input type="submit" value="Submit" width="90px" class="sub">
</form>
...
<form name="search_form" method="post" action="ct.php">
<input type="text" name="search_box" placeholder="Search the Transaction" />

&nbsp;&nbsp;&nbsp;

<input type="submit" name="search" value="SEARCH.." class="sub1" />

&nbsp;&nbsp;&nbsp;

<input type="submit" name="show" value="SHOW ALL!!" class="sub1"/>
</form>
...
{
$rs1 =mysql_query("select * from transaction");

while ($row1 = mysql_fetch_array($rs1)) {

if($row1['Acc_no']==$row['Acc_no'])
{
echo "<tr><td> ".$row1['Cre_deb']."</td><td>".$row1['Trans_time']."</td><td>".$row1['Amount']."</td></tr>";
...
{
$item= $_POST['search_box'];
$rs1 = mysql_query("select * from transaction where Amount='$item' || Cre_deb='$item' || Trans_time='$item'");
